...
class ValidatorAgent(BasePhaseAgent):
    ...
    def create_task(
        ...
        description = (
            ...
            "The schema_errors field is only for concrete structural, syntax, "
            "or contract problems that are still present. Do not copy general "
            "recommendations into schema_errors.\n"
            ...
            "Treat placeholder sample values in .env.example as acceptable "
            "examples when the implementation clearly reads real values from "
            "environment variables.\n"
            "For CRUD-oriented requests, consider the requirement satisfied when "
            "the implementation exposes the equivalent create, read, update, "
            "and delete handlers for the main resource.\n"
            "If you cannot identify any concrete schema_errors or "
            "missing_requirements and the reviewer has already approved the "
            "implementation, set valid to true and ready_for_delivery to true.\n"
